...
<body>
    ...
    <div class="flex items-center">
        ...
        <div class="bg-cgray w-full h-screen px-10 py-6 flex flex-col gap-y-6 overflow-y-scroll rightbar">
            ...
            <div
                class="booking-card grid justify-items-center gap-4 gap-y-[50px] grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 w-auto">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="relative bg-white rounded-lg dark:bg-gray-700">
                            <form class="mt-4 px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8"
                                ...
                                <h3 class="text-xl font-medium text-gray-900 text-center dark:text-white">Ajukan
                                    Konsultasimu</h3>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="bg-gray-50 border border-gray-300 -mb-4 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        placeholder="Nama Lengkap" value="<?= $user->{'user_username'} ?>" required
                                        readonly>
                                </div>
                                <div>
                                    <label for="email"
                                    ...
                                    <input type="email" name="email" id="email"
                                        class="bg-gray-50 border border-gray-300 -mb-4 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white invalid:text-red-600 invalid:focus:ring-red-600 invalid:focus:border-red-600 peer"
                                        placeholder="email@example.com" value="<?= $user->{'user_email'} ?> " readonly>
                                ...
                                <div>
                                    ...
                                    <div class="timepicker relative form-floating mb-3 w-full"
                                        ...
                                        <select name="time" id="time"
                                            class=" border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 -mb-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="email@example.com" required>
                                            <option value="" disabled selected hidden class="bg-gray-400">Please
                                                Choose...</option>
                                ...
                                <div>
                                    <!-- save student id -->
                                    <input type="text" hidden name="studentId" id="student"
                                        value="<?= $user->{'user_id'} ?>">

                                    <!-- save lecture -->
                                    <input type="text" hidden name="lectureId" id="lecture" value="">
                                    <label for="text"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 after:content-['*'] after:ml-0.5 after:text-red-500">Topik</label>
                                    <textarea id="message" rows="4" name="topic"
                                        ...
                                        placeholder="Tuliskan topik yang ingin dikonsultasikan..." required></textarea>
                                </div>
