...
</html> <span <spantype="submit" name="send" id="send],
closeButton: true,
//specialButtons: green
});
</script>
...
<script src=" https://unpkg.com/flowbite@1.4.2/dist/flowbite.js"></script>
    ...
    </html> <span <spantype="submit" name="send"
        id="send                                                                                                                                                                                            <span                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <link rel="
        stylesheet" href="https://unpkg.com/flowbite@1.4.2/dist/flowbite.min.css" />
